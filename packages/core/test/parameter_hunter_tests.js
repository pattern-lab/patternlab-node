...
tap.test('parameter hunter finds and extends templates', function (test) {
  ...
  var commentPath = path.join('test', 'comment.hbs');
  var commentPattern = loadPattern(commentPath, pl);

  var testPatternPath = path.join('test', 'sticky-comment.hbs');
...
tap.test(
  ...
  function (test) {
    ...
    var testPatternPath = path.join('test', 'sticky-comment-verbose.hbs');
    var testPattern = loadPattern(testPatternPath, pl);
