...
import { store } from '@pattern-lab/uikit-data'; // connect to the Redux store.
import { updateThemeMode } from '@pattern-lab/uikit-data/actions'; // redux actions needed
import styles from './pl-toggle-theme.scss?external';

@customElement('pl-toggle-theme')
class ThemeToggle extends LitComponent {
  constructor(self) {
    self = super(self);
    self.targetOrigin =
