...
export const partialsRE = new RegExp(/{{>\s*?([\w\-./~]+)(?::[A-Za-z0-9-_|]+)?(?:(?:| )\(.*)?(?:\s*)?}}/g);

// look for an opening mustache include tag, followed by >=0 whitespaces
let partialsWithStyleModifiersStr = '{{>\\s*';
...
partialsWithStyleModifiersStr += '\\s*}}';
export const partialsWithStyleModifiersRE = new RegExp(partialsWithStyleModifiersStr, 'g');

// look for an opening mustache include tag, followed by >=0 whitespaces
let partialsWithPatternParametersStr = '{{>\\s*';
...
// look for >=0 whitespaces, followed by closing mustache tag
partialsWithPatternParametersStr += '\\s*}}';
export const partialsWithPatternParametersRE = new RegExp(partialsWithPatternParametersStr, 'g');
...
// look for >=0 whitespaces, followed by closing mustache tag
listItemsStr += '\\s*}}';
export const listItemsRE = new RegExp(listItemsStr, 'g');
...
// look for >=0 whitespaces, followed by closing mustache tag
partialKeyStr += '\\s*}}';
export const partialKeyRE = new RegExp(partialKeyStr, 'g');
