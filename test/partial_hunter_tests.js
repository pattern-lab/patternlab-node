(function () {
  ...
  exports['partial_hunter'] = {
    'partial hunter finds and extends templates' : function(test){
    ...
    'partial hunter finds and extends templates with global data' : function(test){
      var currentPattern = currentPatternClosure();
      var patternlab = patternlabClosure();
      var pattern_assembler = new pa();
      var partial_hunter = new ph();

      currentPattern.template = "{{> molecules-single-comment }}";
      ...
      currentPattern.engine.preprocessPartials(pattern_assembler, patternlab);
      partial_hunter.replace_partials(currentPattern, patternlab);
      currentPattern.extendedTemplate = pattern_assembler.renderPattern(currentPattern, currentPattern.allData);
      test.equals(currentPattern.extendedTemplate, '<h1>Bar</h1><p>Baz</p>');

      test.done();
    },

    'partial hunter finds and extends templates with mixed parameter and global data' : function(test){
      var currentPattern = currentPatternClosure();
      var patternlab = patternlabClosure();
      var pattern_assembler = new pa();
      var partial_hunter = new ph();
    ...
    'partial hunter parses parameters with values containing a closing parenthesis' : function(test){
    ...
    'partial hunter parses parameters that follow a non-quoted value' : function(test){
      // From issue #291 https://github.com/pattern-lab/patternlab-node/issues/291
      var currentPattern = currentPatternClosure();
      var patternlab = patternlabClosure();
      var pattern_assembler = new pa();
    ...
    'partial hunter parses parameters whose keys contain escaped quotes' : function(test){
      // From issue #291 https://github.com/pattern-lab/patternlab-node/issues/291
      var currentPattern = currentPatternClosure();
      var patternlab = patternlabClosure();
      var pattern_assembler = new pa();
    ...
    'partial hunter skips malformed parameters' : function(test){
      // From issue #291 https://github.com/pattern-lab/patternlab-node/issues/291
      var currentPattern = currentPatternClosure();
      var patternlab = patternlabClosure();
      var pattern_assembler = new pa();
    ...
    'partial hunter parses parameters containing html tags' : function(test){
