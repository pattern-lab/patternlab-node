...
tap.test('cascade_pattern_states promotes a lower pattern state up to the consumer', function (test) {
  ...
  var atomPattern = new of.Pattern(testPatternsPath, '00-test/01-bar.mustache');
  ...
  var consumerPattern = new of.Pattern(testPatternsPath, '00-test/00-foo.mustache');
...
tap.test('cascade_pattern_states sets the pattern state on any lineage patterns reverse lineage', function (test) {
  ...
  var atomPattern = pattern_assembler.load_pattern_iterative(testPatternsPath, '00-test/01-bar.mustache', pl);
  var consumerPattern = pattern_assembler.load_pattern_iterative(testPatternsPath, '00-test/00-foo.mustache', pl);
